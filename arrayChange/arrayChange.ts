...
function arrayChange2(inputArray: number[]): object {
    let counter = 0;
...
console.log(arrayChange2([1, 1, 1])); // { array: [1, 2, 3], counter: 3}
console.log(arrayChange2([-1, 1, 1])); // { array: [-1, 0, 1], counter: 1}
console.log(arrayChange2([2, 1, 5])); // { array: [2, 3, 4], counter: 3}
